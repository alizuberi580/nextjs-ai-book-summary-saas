    ...
    <div>
      ...
      <div className="mb-6 flex items-center space-x-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold ${filter === "PENDING"
              ? "bg-indigo-600 text-white"
              : "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50"
            } `}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold ${filter === "APPROVED"
              ? "bg-indigo-600 text-white"
              : "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50"
            } `}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-semibold ${filter === "REJECTED"
              ? "bg-indigo-600 text-white"
              : "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50"
            } `}
        >
