                                ...
                                {recentUsers.map((user) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            <span
                                                className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${user.subscriptionTier === "LIFETIME"
                            ...
                            <div className="space-y-4">
                                {recentBooks.map((book) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            <span
                                                className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${book.isPublished
