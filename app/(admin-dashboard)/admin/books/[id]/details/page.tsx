                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <span
                                    className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${book.isPublished
                            ...
                            <div>
                                ...
                                <span
                                    className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${book.isFeatured
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span
                                    className={`px-3 py-1 rounded-full text-xs font-semibold ${book.summaryGenerated
                                            ? "bg-green-100 text-green-700"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span
                                    className={`px-3 py-1 rounded-full text-xs font-semibold ${book.audioGenerated
                                            ? "bg-green-100 text-green-700"
                                            : "bg-red-100 text-red-700"
                                        } `}
                                >
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            ...
                                            {chapter.audioUrl && (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg font-semibold transition-colors ${currentAudio === chapter.id
