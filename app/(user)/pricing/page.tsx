            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    {plans.map((plan) => (
                        <div
                            key={plan.type}
                            className={`relative bg-white rounded-2xl shadow-xl border-2 transition-all hover:shadow-2xl ${plan.popular
                        ...
                        >
                            ...
                            <div className="p-8">
                                ...
                                <button
                                    ...
                                    className={`w-full py-3 rounded-lg font-semibold mb-6 transition-all ${plan.popular
